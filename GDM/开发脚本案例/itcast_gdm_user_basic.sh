...
#定义任务提交的脚本
SPARK_SUBMIT_INFO="/export/server/spark/bin/spark-sql --master spark://node-1:7077 --executor-memory 1g --total-executor-cores 2 --conf spark.sql.warehouse.dir=hdfs://node-2:9000/user/hive/warehouse"
